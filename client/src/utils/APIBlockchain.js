...
let json = require('./Contract.json'); // ce json est créé après le migrate truffle et permet de récupérer l'adresse. On peut mettre l'adresse en dure à la ligne address lors du lancement de ganache sinon.
...
const address = json2.networks[5777].address; // adresse du smartcontract
